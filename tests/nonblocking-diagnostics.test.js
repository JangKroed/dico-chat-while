...
test('로그 저장이 끝나지 않아도 실제 상태 저장과 전송 준비를 계속할 수 있다',async()=>{
 ...
 chrome:{storage:{local:{get:async()=>({state:{channels:[]}}),set:async v=>saved=v.state}},action:{setBadgeText:async()=>{},setBadgeBackgroundColor:async()=>{}}},
 recordDiagnostics:()=>{logged=true;return new Promise(()=>{});},notifyChannelErrors:async()=>{},console,
 });
