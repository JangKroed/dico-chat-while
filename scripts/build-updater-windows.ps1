...
& $csc /nologo /utf8output /codepage:65001 /target:exe /out:dist/updater-windows/DICO-Updater.exe @refs updater/Windows.cs
if ($LASTEXITCODE -ne 0) { throw 'Windows helper build failed' }
& $csc /nologo /utf8output /codepage:65001 /target:exe /main:UpdaterTests /out:dist/updater-windows/tests.exe @refs updater/Windows.cs tests/updater/WindowsTests.cs
...
& dist/updater-windows/tests.exe dist/updater-windows/fixtures
