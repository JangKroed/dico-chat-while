...
for (const file of ['recovery-status.js', 'loading-recovery.js', 'settings-backup.js', 'backup-settings-ui.js', 'email-report.js', 'email-settings.js', 'diagnostics.js', 'diagnostic-settings.js', 'notifications.js', 'notification-settings.js', 'readiness.js', 'controller.js', 'channel-manager.js', 'background.js', 'content.js', 'ui.js', 'ui-state.js']) {
