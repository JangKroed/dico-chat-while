...
const TRACE_BOOLEANS = ['sameSendingReplacement','sameSendingNode','sameSendingRow','observedSendingAuthor','authorized','rawTextMatches','emojiEquivalent','pageHidden','documentFocused','editorFocused','editorConnected','editorReplaced','selectionInside','selectionCollapsed','textMatches','draftEmpty','composing','pastePrevented','enterPrevented','keyupPrevented','newMessage','matchingMessage','sendingSeen','failedSeen','authorMismatch','authorUnknown','timeMismatch','targetMatches','slowmodeDetected','draftMatchesA','draftMatchesB','draftHasVoid','whitespaceOnlyDifference','unsupportedEditorContent'];
const TRACE_NUMBERS = ['removedSendingCount','ambiguousReplacementCount','linkedReplacementCount','elapsedMs','latenessMs','editorCount','draftLength','selectionRanges','cooldownMs','slowmodeSeconds','eventAt','scheduledAt','startedAt','maxStableMs','maxSampleGapMs','sampleCount','stableRequiredMs','stableWaitMs','expectedLength','messageALength','messageBLength','draftLineCount','expectedLineCount','renderedDraftLength','unicodeEmojiCount'];
